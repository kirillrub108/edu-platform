<!-- Final CTA (design_handoff_edllm). Card with soft radial halo + the same
     pulsing primary button as the hero. padding-top:0 matches the design (it
     sits right under the pricing section). -->
<template>
