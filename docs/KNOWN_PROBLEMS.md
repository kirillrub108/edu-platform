...
- **Где:** [backend/app/services/lesson_material_service.py](../backend/app/services/lesson_material_service.py) (`register_uploaded_file`, `get_course_knowledge`), [backend/app/routers/uploads.py](../backend/app/routers/uploads.py), [backend/app/constants.py](../backend/app/constants.py) (`LESSON_MATERIAL_MAX_INLINE_FILES`). Контекст решения — `DECISIONS.md` §61.
